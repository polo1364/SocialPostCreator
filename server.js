...
2. 每則貼文必須風格鮮明且差異明顯，不可雷同
3. 貼文要自然、口語化，符合台灣社群媒體調性
4. 適當加入相關的 Emoji 表情符號增加視覺吸引力
5. 每則貼文長度控制在 50-200 字之間
6. 內容要能引發互動（按讚、留言、分享）
7. 如果有店家資訊，務必參考真實資料，不可編造
8. ${randomOpening}，避免使用太過制式的開頭
9. 可以用問句、感嘆句、對話式等多種開頭方式
10. 避免重複使用相同的表達方式和句型
11. ⚠️ 不要在貼文中加入任何亂碼、無意義的數字或外語詞彙！
